...
برای مشاهده تاریخچه بروز این مشکل [این مطلب](https://github.com/Hameds/GoogleBackup/issues/25) را مشاهده بفرمایید. همچنین برای بعضی از کاربران ایمیل تغییر منطقه از طرف گوگل [ارسال شده است](https://github.com/Hameds/GoogleBackup/issues/60) که یا «از» ایران یا به «ایران» بوده است.
...
## جایگزین سرویس‌های گوگل
  گرچه برای بعضی از سرویس‌ها به خصوص مواردی که مورد استفاده برنامه‌نویسان است جایگزینی وجود ندارد، اما در [این صفحه](https://github.com/tycrek/degoogle) لیست بزرگی از جایگزین‌های مربوط به سرویس‌های مختلف گوگل وجود دارد که بر حسب علاقه می‌توانید از آن‌ها استفاده کنید
...
- برنامه‌نویس هستم و برای دسترسی به سرویس‌ها مشکل دارم. چه کنم؟ اگر اکانت شما غیرفعال نشده ظاهراً در حال حاضر از [fodev.org](http://fodev.org) برای دسترسی داشتن می‌تونید استفاده کنید. کدی هم [اینجا](https://github.com/amirdaaee/LiDns) نوشته شده که می‌توانید تست کنید.

## نشت‌های احتمالی

**بروزرسانی** با توجه به انواع مختلف حالات پیش آمده، موضوع نشت به صورت قطعی مشخص نیست و حتی شواهدی وجود دارد که ممکن است نشت از موارد مطرح شده فعلی نباشد. یکی دیگر از احتمال‌ها مربوط به نشت از اندروید [منبع](https://twitter.com/vforve2/status/1378376027790049283) می‌باشد. همچنین نشت روی OpenVPN [گزارش شده](https://github.com/Hameds/GoogleBackup/issues/54) که در طی آن در پروسه ثبت‌نام Workspace گوگل تفاوت کشورIP با کشور ثبت‌نامی تشخیص داده می‌شود.
