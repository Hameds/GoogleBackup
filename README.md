...
- برنامه‌نویس هستم و برای دسترسی به سرویس‌ها مشکل دارم. چه کنم؟ اگر اکانت شما غیرفعال نشده ظاهراً در حال حاضر از [fodev.org](http://fodev.org) برای دسترسی داشتن می‌تونید استفاده کنید.
