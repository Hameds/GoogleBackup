...
## جایگزین سرویس‌های گوگل
  گرچه برای بعضی از سرویس‌ها به خصوص مواردی که مورد استفاده برنامه‌نویسان است جایگزینی وجود ندارد، اما در [این صفحه](https://degoogle.jmoore.dev/) لیست بزرگی از جایگزین‌های مربوط به سرویس‌های مختلف گوگل وجود دارد که بر حسب علاقه می‌توانید از آن‌ها استفاده کنید
